            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("2.0.0", new Info
                    {
                        ...
                        Description = "Callback Server for Workflow Server API (ASP.NET Core 2.0)",
                        Contact = new Contact()
                        {
                           Name = "OptimaJet",
                    ...
                    c.DocumentFilter<BasePathFilter>("/callbackapi");
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            app
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/swagger/2.0.0/swagger.json", "Callback Server for Workflow Server API");

                    //TODO: Or alternatively use the original Swagger contract that's included in the static files
                    // c.SwaggerEndpoint("/swagger-original.json", "Callback Server for Workflow Server API Original");
                });
